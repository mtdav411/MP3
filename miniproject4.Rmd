...
In addition, horses, sheriff, cowboys, and a battle of the good and evil Western genre that dominated cinema's first half-century went through many changes, from the golden age of the classical Westerns to italian western, anti-western, and finally sci-fi western and neo-western. 

Hollywood studios are good at retelling stories. They are packaged and presented with good music and cast. The stories are told for the culture that demands them. [This website](http://www.filmsite.org/20sintro.html) shows the history of film, beginning in 1920s, there were major changes to the dynamic and structure of production companies. In 1950, there was only four films made that was non-western.  
...
From the IMDB database, we found the top 10 movies with the highest ratings. We can compare the slight difference in both table, which means they do have some correlation. However, the definition of the movies are different. Movies in the rating category are more about how well it’s made where as gross box office means there’s a wider range of audience it appeals to. 
