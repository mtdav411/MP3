...
We aimed to see the definition of movie in 1950 and 2014 from the perspective of *budget*, *country* and *popularity*. We tried to filter out the items *budget* and *country* from the original dataset and see if there are any trend in these two aspects.
...
We found that Western movies in 1950 tends to have less budget than western movies in 2014, but again this is not accounting for inflation.
...
Hollywood studios are good at retelling stories. They are packaged and presented with good music and cast. The stories are told for the culture that demands them. The popularity of the genre declined as it was seen to be out-of touch with the audience. In the corporate capitalistic society, the strongest fist will win in a individual fight, however there is still rule and order. Between 1920 and 1960, production companies were fighting with television series over the market [The History of Film
The 1920s] (http://www.filmsite.org/20sintro.html). 
