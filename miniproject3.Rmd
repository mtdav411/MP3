...
From the IMDB database, we found the top 10 movies with the highest gross box office. Out of the many attempts of movie creations, what attributes worked in presenting a story that audience enjoy? [Top ten Western by gross](http://www.boxofficemojo.com/genres/chart/?id=western.htm)
...
Also from the IMDB database, we found the top 10 movies with the highest ratings. We can compare the slight difference in both table. Movies in the rating category are more about how well it’s made where as gross box office means there’s a wider range of audience it appeals to. 
```{r}
